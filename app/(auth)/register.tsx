        ...
        >
          ...
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.subText}>
              Gérez vos prestations et frais efficacement.
            </Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity>
              <Text style={styles.forgotPassword}>Choisissez un mot de passe fort</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.createAccountButton} onPress={handleLogin}>
              <Text style={styles.createAccountText}>Connectez-vous ici</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  logoContainer: { alignItems: 'center', marginVertical: 20, paddingHorizontal: 30 },
  mainLogoCircle: {
    backgroundColor: '#f0f6ff',
    padding: 10,
    borderRadius: 50,
  ...
  label: { fontWeight: '600', color: '#1e293b', marginBottom: 8, marginTop: 15 },
  inputContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    borderWidth: 1,
