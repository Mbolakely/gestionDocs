...
const getBarHeight = (value: number) => {
  ...
  const MAX_BAR_HEIGHT = CHART_MAX_HEIGHT * 0.75;
  const h = (value / chartMax) * MAX_BAR_HEIGHT;
  ...
  const BAR_WIDTH = Math.min(50, (width - 160) / bars.length);

  // Progress dynamique
  const progress = (stats.total / chartMax) * 100;
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.mainKpiCard}>
          ...
          <Text style={styles.mainAmount}>
            {formatBigAmount(stats.total)}Ar
          </Text>
